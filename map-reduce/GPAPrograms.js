//Average Academic Average (GPA) by Program: Calculate the average academic average (GPA) of graduates for each program.
//------------------------------------------------------------------Change depending on pipeline
// Define the names of the old and new collections
const oldCollection = "graduate";
const newCollection = "GPAProgram";
...
var aggregationPipeline = [
    ...
    },
    {
        $group: {
            ...
            average_gpa: { $avg: { $toDecimal: "$graduateHasPrograms.academicAvg" } }
        }
    },
    {
        $project: {
