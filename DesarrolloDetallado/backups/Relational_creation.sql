...
CREATE TABLE IF NOT EXISTS `grad_db`.`DegreeWork` (
  ...
  INDEX `fk_DegreeWork_Graduate1_idx` (`idGraduate` ASC) VISIBLE,
  INDEX `fk_DegreeWork_Program1_idx` (`idProgram` ASC) VISIBLE,
  CONSTRAINT `fk_DegreeWork_Graduate1`
    FOREIGN KEY (`idGraduate`)
    REFERENCES `grad_db`.`Graduate` (`idGraduate`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DegreeWork_Program1`
    FOREIGN KEY (`idProgram`)
    REFERENCES `grad_db`.`Program` (`idProgram`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `grad_db`.`ResearchWork` (
  ...
  INDEX `fk_ResearchWork_Graduate1_idx` (`idGraduate` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_ResearchWork_GroupAssociation1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ResearchWork_Graduate1`
    FOREIGN KEY (`idGraduate`)
    REFERENCES `grad_db`.`Graduate` (`idGraduate`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
