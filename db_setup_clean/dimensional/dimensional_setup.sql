...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`dim_professor` ;
...
CREATE TABLE IF NOT EXISTS `grad_dimensional`.`fact_studentsupport` (
  ...
  `Founding_Source` ENUM('Internal', 'External') NOT NULL,
  `Payment_Class` ENUM('Monetary', 'Services') NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_DegreeWork` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_ResearchWork` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_Publication` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_Publication_has_dim_graduate` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_DegreeWork_has_dim_graduate` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_ResearchWork_has_dim_graduate` ;
