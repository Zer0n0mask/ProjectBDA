...
-- -----------------------------------------------------
-- Table `grad_dimensional`.`dim_job`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`dim_job` ;

CREATE TABLE IF NOT EXISTS `grad_dimensional`.`dim_job` (
  `idJob` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `grad_dimensional`.`dim_program` (
  ...
  `academic_avg` VARCHAR(45) NULL DEFAULT NULL,
  ...
  `administrativeDependency_name` VARCHAR(150) NULL DEFAULT NULL,
  PRIMARY KEY (`idProgram`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `grad_dimensional`.`fact_graduate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_graduate` ;

CREATE TABLE IF NOT EXISTS `grad_dimensional`.`fact_graduate` (
  `idGraduate` INT NOT NULL,
  `docTipe` ENUM('CC', 'Passport', 'CE', 'Other') NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `lastname` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `grad_dimensional`.`fact_services`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grad_dimensional`.`fact_services` ;

CREATE TABLE IF NOT EXISTS `grad_dimensional`.`fact_services` (
  ...
  `e_off_idEmploymentOffer` INT NULL DEFAULT NULL,
  `e_off_company_name` VARCHAR(100) NULL DEFAULT NULL,
  `e_off_available_until_date` DATE NULL DEFAULT NULL,
  `e_off_contact_email` VARCHAR(150) NULL DEFAULT NULL,
  `e_off_seeking_knowledge_area` VARCHAR(45) NULL DEFAULT NULL,
  `e_off_seeking_academic_lvl` ENUM('Undergraduate', 'Graduate', 'Doctorate') NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
